...
Dynamic user list using RecyclerView

Custom item layout (avatar, name, email)

Navigation to ProfileActivity via explicit Intent

Data passing between activities

Clean Model–Repository–Adapter structure
